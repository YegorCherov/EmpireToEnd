...
public class TerrainGenerator : MonoBehaviour
{
    ...
    public float[,] GenerateNoiseMap(int mapWidth, int mapHeight, NoiseSettings settings, int seed)
    {

        float[,] noiseMap = Noise.GenerateNoiseMap(mapWidth, mapHeight, settings, seed);
